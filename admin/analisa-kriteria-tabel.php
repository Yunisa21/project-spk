      ...
      <tbody>
		...
		<table width="100%" class="table table-striped table-bordered">
			...
			<tfoot>
				<tr class="table table-striped table-bordered">
					<th colspan="3">Jumlah Hasil</th>
					<th><?php $jumlah = $total; echo number_format($jumlah, 4, '.', ','); ?></th>
				</tr>
				<tr class="table table-striped table-bordered">
		...
		<table width="100%" class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<th>CI</th>
					<td><?php $ci = ($rata-$count)/($count); echo number_format($ci, 4, '.', ',');?></td>
				</tr>
				<tr>
					<th>CR</th>

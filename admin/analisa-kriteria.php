			...
			<div class="panel-body">
				<form method="post" action="analisa-kriteria-tabel.php">
					...
					<?php $no=1; foreach ($r as $k => $v): ?>
						...
						<?php endfor; ?>
					<?php endforeach; ?>
					<button type="submit" name="submit" class="btn btn-dark"> Selanjutnya <span class="fa fa-arrow-right"></span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<align="center">Penilaian di atas diberikan oleh Anda sesuai dengan kebutuhan Anda
				</form>
			</div>
		</div>
	</div>
